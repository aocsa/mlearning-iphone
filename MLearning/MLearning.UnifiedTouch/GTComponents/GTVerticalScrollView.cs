...
namespace ComponentsApp
{
	...
	public class GTVerticalScrollView :UIView
	{
		...
		void addtmpcontent()
		{
			...
			topimg.Image = UIImage.FromFile ("MLResources/topwhite1.png");
			_topview.Add (topimg);
...
//			_scroll.Add (contentView);
		...
		{ 
			...
			contentView = new UIView (new CGRect(0,_defaultheight,320, height));
		...
		public UIImage MainImage {
			...
			set
			{
				...
				_mainimage.ContentMode = UIViewContentMode.ScaleToFill;
				_mainimage.SetNeedsDisplay ();
			}
		}
