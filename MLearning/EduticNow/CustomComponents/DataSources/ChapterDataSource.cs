...
namespace MLearning.UnifiedTouch.CustomComponents
{
	public class ChapterDataSource : INotifyPropertyChanged
	{
		...
		private CGColor cgchapterColor;
		public CGColor CGChapterColor 
		{
			get { return cgchapterColor; }
			set 
			{
				cgchapterColor = value;
				if (PropertyChanged != null)
					PropertyChanged (this, new PropertyChangedEventArgs ("CGChapterColor"));
			}
		}
