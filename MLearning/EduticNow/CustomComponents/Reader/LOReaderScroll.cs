...
namespace MLearning.UnifiedTouch
{
	...
	public class LOReaderScroll : UIScrollView
	{
		...
		public LOReaderScroll (List<IStackItem> items) : base ()
		{
			...
			leftArrow = new UIButton (UIButtonType.Custom) { Frame = new CGRect (2, 366, 37, 35) };
			leftArrow.SetBackgroundImage (UIImage.FromFile ("iOS Resources/slides/doublearrow.png"), UIControlState.Normal);
			...
			leftArrow.Layer.ZPosition = 110;

			rightArrow = new UIButton (UIButtonType.Custom) { Frame = new CGRect (985, 366, 37, 35) };
			rightArrow.SetBackgroundImage (UIImage.FromFile ("iOS Resources/slides/doublearrow.png"), UIControlState.Normal);
			rightArrow.Transform = CGAffineTransform.Rotate (rightArrow.Transform, (float)Math.PI);
			...
			rightArrow.Layer.ZPosition = 110;
