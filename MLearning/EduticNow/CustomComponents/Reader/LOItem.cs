...
namespace MLearning.UnifiedTouch
{
	public class LOItem : UIView
	{
		...
		public LOItem (nfloat yPos) : base()
		{
			BackgroundColor = UIColor.Clear;
			Frame = new CGRect (0, yPos, 380, 20);
			bullet = new UIView (new CGRect (3, 17, 14, 14));
			bullet.Layer.CornerRadius = 7;
			bullet.BackgroundColor = UIColor.Black;
			Add (bullet);

			text = Constants.makeLabel(new CGRect (30, 12, 350, 20), UIColor.Black, UITextAlignment.Left, Font.Light, 18);
			text.Lines = 0;
